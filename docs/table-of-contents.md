...
│   │                                   [table generated by scripts/reading-order]
│   ├── vocabulary.txt                  The closed set of words, as declarations
│   │                                   [generated by scripts/vocabulary]
...
│   ├── datapath-chokepoints.md         The gates every request passes, and where data
│   │                                   changes memory host
...
│   ├── 025-enums/                      The closed sets, as identity-comparable members
│   ├── 033-mechanisms/                 The four hands, given one doorway
│   ├── 039-memory/                     Chatlog, scratchspace, sheet -- and what is attended to
│   ├── 041-vision/                     Cameras, and turning a pixel into a place
│   └── 045-toolbox/                    The registry, and the tool list drawn from it
